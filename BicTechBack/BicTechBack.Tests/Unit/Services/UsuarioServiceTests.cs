...
namespace BicTechBack.Tests.Unit.Services
{
    public class UsuarioServiceTests
    {
        ...
        public async Task CreateUsuarioAsync_UsuarioValido_CreaUsuarioYRetornaDTO()
        {
            ...
            mockMapper.Setup(m => m.Map<UsuarioDTO>(It.IsAny<Usuario>())).Returns(new UsuarioDTO { Id = 1, Nombre = dto.Nombre, Email = dto.Email, Password = dto.Password, Rol = "User" });
        ...
        public async Task UpdateUsuarioAsync_UsuarioActualizado_RetornaDTO()
        {
            ...
            mockMapper.Setup(m => m.Map<UsuarioDTO>(It.IsAny<Usuario>())).Returns(new UsuarioDTO { Id = 1, Nombre = "Nuevo", Email = "nuevo@mail.com", Password = "new" });
